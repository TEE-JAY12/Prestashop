...
Feature: Cart calculation with rounding mode UP
  ...
  Scenario: Empty cart
    ...
    Given specific shop configuration for "rounding mode" is set to round up
  ...
  Scenario: one product in cart, quantity 1
    ...
    Then my cart total should be 26.82 tax included
    Then my cart total using previous calculation method should be 26.82 tax included
