...
Feature: Cart calculation with rounding mode DOWN
  ...
  Scenario: Empty cart
    ...
    Given specific shop configuration for "rounding mode" is set to round down
  ...
  Scenario: one product in cart, quantity 3
    ...
    Then my cart total should be 66.43 tax included
    Then my cart total using previous calculation method should be 66.43 tax included
  ...
  Scenario: 3 products in cart, several quantities
    ...
    Then my cart total should be 162.38 tax included
    Then my cart total using previous calculation method should be 162.38 tax included
