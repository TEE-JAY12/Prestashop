...
export default {
  ...
  productsTableRow: (productId: string): string => `#orderProduct_${productId}`,
  productsTableRowEdited: (productId: string): string => `#editOrderProduct_${productId}`,
  ...
  productEditBtn: (productId: string): string => `#orderProduct_${productId} .js-order-product-edit-btn`,
